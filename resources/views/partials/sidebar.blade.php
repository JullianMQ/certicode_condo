...
<aside id="sidebar" class="fixed hidden z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64" aria-label="Sidebar">
    <div class="relative flex-1 flex flex-col min-h-0 bg-white pt-0 shadow-lg">
...
<div class="bg-white bg-opacity-30 hidden fixed inset-0 z-10" id="sidebarBackdrop"></div>
