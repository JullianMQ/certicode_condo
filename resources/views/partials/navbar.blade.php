{{-- Top Navigation Bar for Certicode Condo Dashboard --}}
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="{{ route('dashboard') }}" class="text-xl font-bold flex items-center lg:ml-2.5">
                    <svg class="h-6 mr-2 text-cyan-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <form action="#" method="GET" class="hidden lg:block lg:ml-9 lg:pl-4">
                    ...
                    <div class="mt-1 relative lg:w-64">
                        ...
                        <input type="text" name="search" id="topbar-search" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full pl-10 p-2.5" placeholder="Search residents, units...">
                    </div>
                </form>
            </div>
